...
SELECT Title ,LastName + ', '+ FirstName AS 'Nombre Persona '
FROM Person.Person
GO
...
WHERE ShipDate BETWEEN '2014-07-04 00:00:00.000' 
	   AND '2014-07-05 00:00:00.000';
GO
...
-- --Paging Through A Result Set : New in SQL Server 2014
