...
-- Example Insert 
-- Generate Script Publishers authors
-- Creando Autor misma city  Paris
...
INSERT INTO [dbo].[authors]
           ...
           ,[contract])
     VALUES
           ('172-32-1179','Blanco','Johnson'	,'408 496-7223','10932 Bigge Rd.',
		   '	Paris',	'FR','94025',1)
GO

--au_id	au_lname	au_fname	phone	address	city	state	zip	contract
--172-32-1176	White	Johnson	408 496-7223	10932 Bigge Rd.	Menlo Park	CA	94025	1
--172-32-1179	Blanco	Johnson	408 496-7223	10932 Bigge Rd.	 Paris	FR	94025	1
--213-46-8915	Green	Marjorie	415 986-7020	309 63rd St. #411	Oakland	CA	94618	1


-- Hint: problemas con los espacios en blanco


SELECT TOP 3 *
FROM [dbo].[authors]
WHERE au_id='172-32-1179'
GO
...
-- Copy Record and modify

-- 172-32-1179	Blanco	Johnson	408 496-7223	10932 Bigge Rd.	Paris	94025	True
...
--au_id	au_lname	au_fname	phone	address	city	state	zip	contract	pub_id	pub_name	city	state	country
--172-32-1179	Blanco	Johnson	408 496-7223	10932 Bigge Rd.	Paris	FR	94025	1	9999	Lucerne Publishing	Paris	NULL	France
--238-95-7766	Carson	Cheryl	415 548-7723	589 Darwin Ln.	Berkeley	CA	94705	1	1389	Algodata Infosystems	Berkeley	CA	USA
--409-56-7008	Bennet	Abraham	415 658-9932	6223 Bateman St.	Berkeley	CA	94705	1	1389	Algodata Infosystems	Berkeley	CA	USA

CREATE  PROC ciudad_Autor
